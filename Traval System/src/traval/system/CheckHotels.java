...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text=new String[]{"JW Marriott Hotel","Madarin Orintel Hotel","Four Seasons Hotel","Radisson Blue Hotels","The Taj Hotel","the Bay Club Hotel","Breeze Blow Hotel","Classio Hotel","Happy Morning Motel","River View Hotel","Spanpol Hotel"};
        try{
            for(int i=0;i<=9;i++){
